...
import celebrationGif from "@/src/assets/celebrationgif.gif";
    ...
    return (
      <div>
        <main className="mx-auto max-w-2xl px-4 py-16 text-center">
          ...
          <h1 className="mt-10 text-2xl md:text-4xl leading-tight font-cormorant">
    ...
    <div>
      <main>
        ...
        <div className="bg-[#1d1e1c] w-full pt-10 pb-8 text-center">
          <Link href="/">
            <Image src={logo} alt="M3" className="mx-auto h-12 w-auto" priority />
          </Link>
        </div>
        ...
        <section className="bg-[#1d1e1c]">
          <div className="mx-auto max-w-5xl px-4 pb-8">
            <h1 className="text-[2.4rem] md:text-[3.9rem] text-center leading-[1.05] text-white font-cormorant">
