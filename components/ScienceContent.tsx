    ...
    <div className="font-sans bg-white text-[#1a1a1a] leading-[1.65]">
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-2xl px-4 py-16 sm:py-24">
          ...
          <header className="mb-10">
            <h2 className="text-4xl leading-tight font-bodoni">Core Principles</h2>
          </header>
      ...
      <article className="border-b border-border">
        <div className="mx-auto max-w-2xl px-4 py-16 sm:py-24">
          ...
          <header className="mb-10">
            <h1 className="text-4xl leading-tight font-bodoni">Why Every Day Looks A Little Different</h1>
          </header>
      ...
      <section>
        <div className="mx-auto max-w-5xl px-4 py-16 md:py-20">
          ...
          <header className="mb-8">
            <h2 className="text-4xl leading-tight font-bodoni">Nutrient Schedule Grid</h2>
          </header>
