        ...
        <div className="flex flex-col items-center gap-10 md:flex-row md:items-start md:justify-between">
          ...
          <div className="flex flex-col items-center gap-4 md:items-end">
            <div className="flex flex-wrap justify-center gap-x-8 gap-y-2 text-sm text-white md:justify-end">
              ...
              <a href="https://x.com/maxmendmethod" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-black" style={{ fontFamily: '"Arimo", sans-serif' }}>X</a>
